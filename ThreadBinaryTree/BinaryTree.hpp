...
//  34研讨
//
//  Created by 乔尔 on 2020/3/4.
//  Copyright © 2020 乔尔. All rights reserved.
//

#ifndef testBinaryTree_hpp
#define testBinaryTree_hpp


#include "LinkQueue.hpp"               // 链队列
#include "BinTreeNode.hpp"            // 二叉树结点类
...
// 复制二叉树
    ...
    void InOrder(BinTreeNode<ElemType>*r,void (*Visit)(const ElemType &)) const;
        // 中序遍历以r为根的二叉树
    void InOrder_(BinTreeNode<ElemType>*r,void (*Visit)(const ElemType &)) const;
        // 中序遍历以r为根的二叉树 非递归算法
...
//  二叉树方法声明及重载编译系统默认方法声明:
    ...
    void InOrder_(void(*Visit)(const ElemType &)) const; //非递归方式中序遍历
...
template<class ElemType>
void BinaryTree<ElemType>::InOrder_(BinTreeNode<ElemType> *r,void(*Visit)(const ElemType &)) const
{
    LinkStack<BinTreeNode<ElemType> *> s;
    BinTreeNode<ElemType> *p = r; //根结点入
...
template<class ElemType>
void BinaryTree<ElemType>::InOrder_(void(*Visit)(const ElemType &)) const
{
    InOrder_(root, Visit);
}

#endif /* testBinaryTree_hpp */
